...
document.querySelectorAll(".legal-row").forEach((legalRow) => {
  legalRow.innerHTML =
    '<p class="legal-copy">&copy; 2026 MSquare Professionals Pvt. Ltd. All rights reserved.</p><div class="legal-links"><a href="contact.html">Privacy Policy</a><a href="contact.html">Terms of Service</a></div>';
});
...
if (contactSection) {
  ...
  const contactIntro =
    contactSection.querySelector(".contact-intro");
...
const heroHeadingParts = {
  "case-studies.html": [
    "Measurable work",
    " across campaigns, websites, and systems."
  ],
  ...
  "insights.html": [
    "Practical resources",
    " for teams building modern growth systems."
  ],

  "services.html": [
    "Growth systems",
    " built around your next stage."
  ]
};
...
if (
  heroHeading &&
  headingParts &&
  !heroHeading.querySelector("span")
) {
  heroHeading.innerHTML =
    `${headingParts[0]}<span>${headingParts[1]}</span>`;
}
...
if (!document.querySelector(".whatsapp-float")) {
  ...
  document.body.insertAdjacentHTML(
    ...
    `<a class="whatsapp-float" href="https://api.whatsapp.com/send/?phone=919870202444&amp;text=Hi+MSquare%21+I+visited+your+website+and+would+like+to+know+more+about+your+services.&amp;type=phone_number&amp;app_absent=0" target="_blank" rel="noreferrer" aria-label="Chat with us on WhatsApp">
...
const GOOGLE_SCRIPT_URL =
  "https://script.google.com/macros/s/AKfycbx56rz6PwE2np_mnC2L_6GZoPnb17fUqLPHsKWoDLvoiEeV1kaTPdOpN0cmq1ThWEI8Jg/exec";
